...
mlflow.set_tracking_uri("file:///mlruns")   # complete the code to set the MLflow tracking URI
...
numeric_features = ["Age", "CityTier", "DurationOfPitch", "NumberOfPersonVisiting", "NumberOfFollowups", "PreferredPropertyStar", "NumberOfTrips", "PitchSatisfactionScore", "NumberOfChildrenVisiting", "MonthlyIncome"]   # complete the code to list all numerical feature names (same as in prep.py)

categorical_features = ["TypeofContact", "Occupation", "Gender", "ProductPitched", "MaritalStatus", "Passport", "OwnCar", "Designation"]   # complete the code to list all categorical feature names (same as in prep.py)
