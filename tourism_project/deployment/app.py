...
model_path = os.path.join(os.path.dirname(tourism_project/deployment/), "best_tourism_package_model_v1.joblib")   # complete the code: filename of the trained model saved by train.py (must match the filename you used there)
